$(document).ready(function(){
    var OPT = {
        Cols:[
            { Header: "유저명", Name: "username", Type: "Text", Width:80, RelWidth:1},
            { Header: "이메일", Name: "email", Type: "Text", Width:80, RelWidth:1},
            { Header: "전화번호", Name: "phoneNumber", Type: "Text", Width:80, RelWidth:1},
       ]
   };
