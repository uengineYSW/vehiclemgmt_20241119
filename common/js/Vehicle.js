$(document).ready(function(){
    var OPT = {
        Cols:[
            { Header: "차량 등록번호", Name: "licensePlateNumber", Type: "Text", Width:80, RelWidth:1},
            { Header: "차량 브랜드", Name: "brand", Type: "Text", Width:80, RelWidth:1},
            { Header: "차량 모델", Name: "model", Type: "Text", Width:80, RelWidth:1},
            { Header: "자리 수용량", Name: "seatCapacity", Type: "Text", Width:80, RelWidth:1},
